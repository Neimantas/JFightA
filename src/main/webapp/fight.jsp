...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4">Player A</div>
			<div class="col-sm-4">
				Actions
						...
						<div class="col-sm-6">
							...
							<div class="form-check">
								<input class="form-check-input attack" type="checkbox"
									name="attackAction" id="attackAction1" value="head"> <label
									class="form-check-label" for="attackAction1"> Head </label>
							</div>
							<div class="form-check">
								<input class="form-check-input attack" type="checkbox"
									name="attackAction" id="attackAction2" value="body"> <label
									class="form-check-label" for="attackAction2"> Body </label>
							</div>
							<div class="form-check">
								<input class="form-check-input attack" type="checkbox"
									name="attackAction" id="attackAction3" value="body"> <label
									class="form-check-label" for="attackAction3"> Arms </label>
							</div>
							<div class="form-check">
								<input class="form-check-input attack" type="checkbox"
									name="attackAction" id="attackAction4" value="body"> <label
						...
						<div class="col-sm-6">
							...
							<div class="form-check">
								<input class="form-check-input defence" type="checkbox"
									name="defenceAction" id="defenceAction1" value="head">
								<label class="form-check-label" for="defenceAction1">
									Head </label>
							</div>
							<div class="form-check">
								<input class="form-check-input defence" type="checkbox"
									name="defenceAction" id="defenceAction2" value="body">
								<label class="form-check-label" for="defenceAction2">
									Body </label>
							</div>
							<div class="form-check">
								<input class="form-check-input defence" type="checkbox"
									name="defenceAction" id="defenceAction3" value="body">
								<label class="form-check-label" for="defenceAction3">
									Arms </label>
							</div>
							<div class="form-check">
								<input class="form-check-input defence" type="checkbox"
									name="defenceAction" id="defenceAction4" value="body">
			...
			<div class="col-sm-4">Player B</div>
		</div>
	</div>
